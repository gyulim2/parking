-- ============================================================
-- parking_db 더미 데이터 (현재 사용 버전)
--
-- ▶ 데이터 구성 요약
--    주차장  2개 (백화점 1, 아파트 1)
--
--    주차자리 1600개
--      ● Lot 1 (백화점, spot 1~600): 600개
--          지하1층 A·B·C·D구역 (1~200)
--          지하2층 E·F·G·H구역 (201~400)
--          지하3층 I·J·K·L구역 (401~600)
--          구역당: general×42 + disabled×3 + ev×5 = 50자리
--      ● Lot 2 (아파트, spot 601~1600): 1000개
--          지하1층 P·Q·R·S·T·U·V·W·X·Y구역 (601~1600)
--          구역당: general×84 + disabled×8 + ev×8 = 100자리
--
--    차량   10개 (직원 3, 입주민 3, 일반/방문객 4)
--    직원    3명 → 정기권 3개 (유효 2, 만료 1)
--    세대    3개 → 입주민 3명 → 월 납부 내역 6건 (미납 1건 포함)
--    입출차 기록 10개 (완료 8, 주차 중 2)
--    정산   8건 (주차 중인 2개는 아직 정산 없음)
-- ============================================================
